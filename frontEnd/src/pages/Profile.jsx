...
export default function Profile() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto px-2 sm:px-0 pb-12">
      
      {/* --- REALISTIC PROFILE OVERVIEW CARD --- */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card overflow-hidden relative shadow-2xl">
        ...
        <div className="px-6 pb-6 pt-0 relative -mt-10">
          ...
          {/* User Bio snippet if available */}
          {user?.bio && (
            <p className="text-slate-300 text-xs sm:text-sm mb-5 bg-slate-800/40 p-3 rounded-xl border border-slate-700/40 italic">
              "{user.bio}"
            </p>
          )}

          {/* Quick Metrics Grid (Weight, Height, Weekly Target, Hydration) */}
