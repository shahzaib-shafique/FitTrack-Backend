...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col lg:flex-row overflow-x-hidden text-white antialiased">
      {/* Hidden container that holds the pre-rendered Google button */}
      <div id="hiddenGoogleBtnContainer" className="hidden" />

      {/* Left panel - Hidden on mobile/tablets, beautiful on desktop layouts */}
      ...
      {/* Right panel - Fully fluid, mobile-first design */}
      <div className="w-full lg:w-1/2 flex items-center justify-center min-h-screen lg:min-h-0 p-4 sm:p-8 lg:p-12">
        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field pl-10 py-3 text-sm sm:text-base"
                />
              </div>
          ...
          {/* Premium Dark Silver / Slate Responsive Button */}
          <button
            type="button"
          ...
          <p className="text-center text-slate-500 text-xs sm:text-sm mt-6 font-medium">
            ...
            <Link to="/register" className="text-emerald-400 hover:text-emerald-300 font-semibold transition-colors decoration-2">
              Create one
            </Link>
          </p>
        </motion.div>
